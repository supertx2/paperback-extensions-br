...
},{"./MundoMangaKunParser":91,"paperback-extensions-common":16}],91:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseChapters($, mangaId) {
        ...
        for (const obj of $('.capitulos_leitor_online a').toArray()) {
            ...
            const chapNum = (_a = Number(name.replace(/\D/g, ''))) !== null && _a !== void 0 ? _a : 0;
