...
},{"./APIWrapper":2,"./base":15,"./models":58}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Button":20,"./Form":22,"./FormRow":21,"./Header":23,"./InputField":24,"./Label":25,"./Link":26,"./MultilineLabel":27,"./NavigationButton":28,"./OAuthButton":29,"./Section":30,"./Select":31,"./Stepper":32,"./Switch":33,"./WebViewButton":34}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Chapter":18,"./ChapterDetails":17,"./Constants":19,"./DynamicUI":35,"./HomeSection":36,"./Languages":37,"./Manga":40,"./MangaTile":38,"./MangaUpdate":39,"./PagedResults":41,"./RawData":42,"./RequestHeaders":43,"./RequestInterceptor":44,"./RequestManager":45,"./RequestObject":46,"./ResponseObject":47,"./SearchField":48,"./SearchRequest":49,"./SourceInfo":50,"./SourceManga":51,"./SourceStateManager":52,"./SourceTag":53,"./TagSection":54,"./TrackedManga":56,"./TrackedMangaChapterReadAction":55,"./TrackerActionQueue":57}],59:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
...
const GoldenMangasParser_1 = require("./GoldenMangasParser");
...
class GoldenMangas extends paperback_extensions_common_1.Source {
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!search) {
                search = (((_c = (_b = query.includedTags) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0) > 0) ? `genero=${encodeURI(((_d = query.includedTags) === null || _d === void 0 ? void 0 : _d.map(t => t.id).join(',')) || '')}` : '';
            }
            const request = createRequestObject({
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mostReadMangas = createHomeSection({ id: 'mostReadMangas', title: 'Mangás mais lidos', type: paperback_extensions_common_1.HomeSectionType.featured });
            ...
            const newReleases = createHomeSection({ id: 'newReleases', title: 'Novos mangás', type: paperback_extensions_common_1.HomeSectionType.singleRowLarge });
...
exports.GoldenMangas = GoldenMangas;

}).call(this)}).call(this,require("buffer").Buffer)
},{"./GoldenMangasParser":60,"buffer":3,"paperback-extensions-common":16}],60:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    constructor() {
        this.parseHomePageMostReadMangas = ($) => {
            ...
            for (const obj of context.toArray()) {
                ...
                const id = (_a = $obj.attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/mangabr/', '');
        ...
        this.parseHomePageLatestUpdates = ($) => {
            ...
            for (const obj of context.toArray()) {
                const $obj = $(obj);
                const img = $('img', $(obj)).attr('src');
                const id = (_a = $obj.find('a').first().attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/mangabr/', '');
                const title = $obj.find('h3').text().trim();
                if (!id || !title) {
                    continue;
                }
        ...
        this.parseHomePageNewReleases = ($) => {
            ...
            for (const obj of context.toArray()) {
                ...
                let tags = ((_b = $obj.parent()) === null || _b === void 0 ? void 0 : _b.find('.label-warning').toArray().map((l) => $(l).text())) || [];
                if (tags.length > 5) {
                    tags = tags.slice(0, 5);
                    tags.push('...');
                }
    ...
    parseMangaDetails($, mangaId) {
        ...
        const tags = [createTagSection({ id: '0', label: 'genres', tags: genres.map(g => createTag(g)) })];
...
},{"entities":12,"paperback-extensions-common":16}]},{},[59])(59)
});
